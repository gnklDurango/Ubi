...
<%    /*-------------------------------------------------------------------------------------
    ...
    String recibe_cant = "", recibe_ubi = "", recibe_clave = "", recibe_lote = "", recibe_cadu = "", recibe_nocajas = "", recibe_resto = "", recibe_id = "", recibe_descr = "", recibe_marca = "", recibe_um = "", recibe_cmarca = "", recibe_cum = "", codigo_jv = "", folio_gnkl = "", folio_remi = "", recibe_date = "", orden_compra = "", fec_fab = "", observaciones = "";
...
//fin de variables
    ...
    if (but.equals("Buscar")) {
        ...
        try {
            if (sesion.getAttribute("ban").equals("1")) {
                cb = (String) sesion.getAttribute("txtf_cb");
                clave = "";
                lote = "";
...
<%
        ...
        rset_001 = stmt_sed.executeQuery("select clave,lote,ubi from datos_inv_cod where ubi='" + ubic_cb + "' and cant!=0;");
        while (rset_001.next()) {
...
<%
    ...
    if (but.equals("Por Ubicar")) {
        ...
        pos_lot = 0;
        pos = 0;
        rset_001 = stmt_sed.executeQuery("select clave,lote,ubi from datos_inv_cod where  ubi='NUEVO';");
        while (rset_001.next()) {
            cla_ves[pos_cla] = rset_001.getString("clave");
            lot_es[pos_lot] = rset_001.getString("lote");
            exis[pos] = rset_001.getString("ubi");
                        ...
                        <table width="857" height="429" border="1" bordercolor="#003300">
                            ...
                            <tr>
                                <td class="bodyText"><p style="margin-top: 0;"><span class="style1">Código de Barras:
                                            ...
                                            &nbsp;&nbsp;&nbsp;<a href="/Ubi/login?nombre=<%=user%>&ban=1" title="Busca Medicamento por CLAVE y/o LOTE" accesskey="w">Buscar por CLAVE/LOTE</a> &nbsp;&nbsp;<a href="index.jsp">SALIR</a>&nbsp;&nbsp;<a href="http://localhost:8088/SIE">SALIR AL SIE</a></span>
                                        ...
                                        <div align="left" class="style1">&nbsp;&nbsp;Clave:&nbsp;
                                            ...
                                            <select name="slct_cve" onChange="putCla_ves(this.form);
                                                    dimePropiedades2(this.form);">
                                                <option>Clave</option>
...
%>
                            ...
                            <tr>
                                <td class="sidebarHeader"><span class="style1">Ubicaci&oacute;n en el Almac&eacute;n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <%
                                            //Para inventarios el usuario sera algo referente a inventarios
                                            if (user.equals("inventarios")) {

                                        %>
                                        <a href="/Ubi/login?nombre=<%=user%>&ban=2">Agregar una clave al INVENTARIO</a> &nbsp;&nbsp;&nbsp;<a href="/Ubi/login?nombre=<%=user%>&ban=3">Inventario Área de Surtido</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/Ubi/login?nombre=<%=user%>&ban=4">Surtir Folio</a></span>&nbsp;
                                        <%
                                            }
                                        %>
                                    <br />
                                    ...
                                    <table width="1036" border="2" align="center">
                                        ...
                                        <%
                                            ...
                                            {
                                                rset_001 = stmt_sed.executeQuery("select * from datos_inv_cod where clave='1' and cant!=0 order by equipo asc;");
                                            }
                                            if (ban == 1) {
                                                rset_001 = stmt_sed.executeQuery("select * from datos_inv_cod where  ubi='" + ubic_cb + "' and cant!=0;");
                                            }
                                            //rset_001=stmt_001.executeQuery("select * from datos_inv_cod where equipo like '%al%' and (clave='"+clave+"' and lote='"+lote+"');");	  
                                            if (ban == 2) {
                                                rset_001 = stmt_sed.executeQuery("select * from datos_inv_cod where (clave='" + clave + "' and lote='" + lote + "' and ubi='" + ubic + "' and cant!=0);");
                                            }
                                            //  rset_001=stmt_001.executeQuery("select * from datos_inv_cod where clave='"+clave+"';");

                                            if (ban == 3) {
                                                //ubicar=
                                                rset_001 = stmt_sed.executeQuery("select * from datos_inv_cod where  (clave='" + clave + "' and lote='" + lote + "' and ubi='" + ubicar + "' and cant!=0);");
                                            }

                                            if (ban == 4) {
                                                //ubicar=
                                                rset_001 = stmt_sed.executeQuery("select * from datos_inv_cod where  ubi='NUEVO' and cant!=0;");
                                            }
                                            int total_cajas = 0;
                                            while (rset_001.next()) {
                                    //clagto_jv=rset_001.getString("clave"); 
                                        ...
                                        <td class="detailText"><b><!--a href="test1.jsp?id=<%=rset_001.getString("id_cap_inv")%>"--><%=rset_001.getString("id_cap_inv")%><!--/a--></b></td>
                                            <%
                                                if (rol > 2) {
                                            %>
                                            <td class="detailText"><b><a href="/Ubi/login?id_clave=<%=rset_001.getString("id_cap_inv")%>&nombre=<%=user%>&ban=5&cb=<%=cb%>">Modificar?</a></b></td>
                                                        <%
                                                            }
                                                        %>
                                            ...
                                            <%
                                                total_cajas = total_cajas + Integer.parseInt(rset_001.getString("cant"));
                                        ...
                                        <tr>
                                            ...
                                            <td></td>
                                            <td></td>
                                            <td class="detailText">&nbsp;<%=df.format(total_cajas)%></td>
                                            <td></td>
                                        </tr>
                                    </table>	        
                                </td>
                            ...
                            <tr>
                                <td class="detailText">
                                    <span class="sidebarHeader style1">GNKL Software</span> 
                                    <hr />          
                                </td>
                            </tr>
                            <tr>        </tr>
