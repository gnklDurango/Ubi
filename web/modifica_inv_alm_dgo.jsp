...
String eliminar_jv=(String)session.getAttribute("id_prov");
	...
	if(difyear>0){
	 ...
	 // descrip_jv= request.getParameter("txtf_descrip");
			...
			//update datos_prov_1_0807 set cve_med='0113',descri='BUTILHIOSCINA/metamizol 36grag 10mg/250m',lote='S10820',cadu='30/09/2010',cant='57' where id_rem_prov='275';update datos_inv_cod set clave='mmm',descr='mmm',lote='mmm',cadu='nnnn',cant='nnn' where id_cap_inv='1';
	 		...
	 		stmt.execute("update datos_inv_cod set cod_bar='"+cod_jv+"',clave='"+clave_jv+"',descr='"+descrip_jv+"',lote='"+lote2_jv+"',cadu='"+cad2_jv+"',ubi='"+ubi_jv+"',cajas='"+cajas_jv+"',piezas='"+pzas_jv+"',resto='"+resto_jv+"',cant='"+exi_jv+"' ,marca='"+marca_jv+"',um='"+present_jv+"',origen='"+origen_jv+"' where id_cap_inv='"+eliminar_jv+"'");	
			...
			<script>			
			 	//self.location='captura_InvBCAlmLeo.jsp?id_prov=<%//=eliminar_jv%>&hora_ini_vi=<%//=hora_ini_jv%>&equi_vi=<%//=equipo_jv%>&integran_vi=<%//=integrantes_jv%>';					
  				...
  				<%
				stmt.execute("insert into modi_dgo values ('"+usu_jv+"','"+correct1+"','"+date+"','"+clave1_jv+"','"+descrip1_jv+"','"+lote21_jv+"','"+cad21_jv+"','"+ubi1_jv+"','"+cajas1_jv+"','"+pzas1_jv+"','"+resto1_jv+"','"+exi1_jv+"','"+clave_jv+"','"+descrip_jv+"','"+lote2_jv+"','"+cad2_jv+"','"+ubi_jv+"','"+cajas_jv+"','"+pzas_jv+"','"+resto_jv+"','"+exi_jv+"',0)");   
...
<table width="102%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr bgcolor="#3366CC">
    ...
    <td height="58" colspan="3" align="center" valign="bottom" nowrap="nowrap" bgcolor="#FFFFFF" id="logo"><div align="center"><img src="imagenes/logo_conjun.jpg" width="343" height="91" /></div></td>
    <td width="55" bgcolor="#FFFFFF">&nbsp;</td>
  </tr>

  <tr bgcolor="#3366CC">
    <td height="40" colspan="3" align="center" valign="middle" background="imagenes/fondo.jpg"  id="tagline"><div align="left"><span class="di style3"><strong>Modificar Datos del Medicamento</strong></span><span class="di">&nbsp;&nbsp;</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>GNKL Software<span class="style6"> </span></strong></div></td>
	<td width="55" bgcolor="#FFFFFF">&nbsp;</td>
  </tr>
</table>
<table>
 ...
 <tr>
    ...
    <td colspan="2" valign="top"><img src="mm_spacer.gif" alt="" width="305" height="1" border="0" />
	  <form action="modifica_inv_alm_dgo.jsp?id_prov=<%=eliminar_jv%>&hora_ini_vi=<%=hora_ini_jv%>&equi_vi=<%=equipo_jv%>&integran_vi=<%=integrantes_jv%>&usuario=<%=usu_jv%>" method="post" name="form">
          ...
          <table width="821" border="1">
            <%
  			...
  			//select distinct cve_med,descri,lote,cadu,cant,id_rem_prov from datos_prov_1_0807 where id_rem_prov='275'
  				rset__001=stmt__001.executeQuery("select  cod_bar,clave,descr,lote,cadu,ubi,cant,cajas,piezas,resto,marca,um,origen from datos_inv_cod where id_cap_inv='"+eliminar_jv+"'");
...
%>
            ...
            <tr>
              ...
              <td colspan="2" class="bodyText"><input name="txtf_marca" type="text" size="30" onkeypress="return handleEnter(this, event)" value="<%=marca_jv%>"  /><label></label>              </td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td class="bodyText"><strong>PRESENTACION</strong></td>
              <td colspan="2" class="bodyText"><input name="txtf_um" type="text" size="30" onkeypress="return handleEnter(this, event)" value="<%=present_jv%>"  /><label></label>              </td>
              <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td colspan="2"><label>
                <input type='text' name='txtf_ubi' id='txtf_ubi'  size='20' readonly="true" maxlength='10' value="<%=ubi_jv%>"/>
...
<option value="H-40-I">H-40-I </option>
            ...
            <tr>
              ...
              <td height="21"><input name="Submit" type="submit" class="subHeader" value="Modificar"/>
                &nbsp;&nbsp;&nbsp; </td>
              <td height="21"><a href='login?ban=6&id_prov=<%=eliminar_jv%>&amp;hora_ini_vi=<%=hora_ini_jv%>&amp;equi_vi=<%=equipo_jv%>&amp;integran_vi=<%=integrantes_jv%>&nombre=<%=user1%>'>Regresar a Captura de Remisi&oacute;n</a></td>
              <td height="21">&nbsp;</td>
            </tr>
          </table>          
      </tr>
