<%-- 
    Document   : index
    Created on : 11-12-2013, 12:05:12
    Author     : Equipo sistemas DGO 
--%>
...
<html lang="en">
  <head>
    <title>Ingreso Sistema de Ubicaciones</title>
  ...
  <div class="container">
      ...
      <form name ="form" id="forma-login" class="marco" action="/Ubi/login" method="post" >
