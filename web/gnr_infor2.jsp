...
response.setHeader("Content-Disposition","attachment; filename=SUMATORIA POR SICCALES.xls");
%>
<head>
...
<p>
  <%
	...
	{
 rset__001=stmt__001.executeQuery("select clave,descr,sum(cant) from datos_inv_cod group by clave order by clave asc ");
...
<table width="400" cellpadding="3" cellspacing="1" border="2" >
    ...
    <tr height="20">
    <td height="20" colspan="2" style="border:double"><p>EXISTENCIAS ALMAC&Eacute;N DURANGO </p></td>
  </tr>
  
  <tr height="20">
    <td width="52" style="border:double"><div align="center">CLAVE&nbsp;</div></td>
<td width="52" style="border:double"><div align="center">DESCRIPCION&nbsp;</div></td>    
<td width="42" height="20"   style="border:double"><div align="center">
      <p>CANTIDAD    </p>
    </div></td>
...
<td style="border:double" align="left" ><%=descrip_jv%></td>    
<td  style="border:double"><%=cant_pzs%></td>
  </tr>
  <%
  }
  ...
  <tr height="20" >
    <td style="border:double" align="left" >Total de Piezas</td>
