...
function setLetterUbic1(form) 
      		                       {
      		                         var ubic_bod= form.slc_LetterUbic.value;
      		                         form.txtf_ubin.value=ubic_bod;
      		                       }
...
function toUppercaseF3() {
         document.form.txtf_hf.value =  document.form.txtf_hf.value.toUpperCase();
}
...
function toUppercaseUbic1() {
         document.form.txtf_ubin.value =  document.form.txtf_ubin.value.toUpperCase();
}
...
function ValidateCat(form)
								...
								else if( tel2.value=="") { alert('El FORMATO DEL NUMERO TELEFONICO ES INCORRECTO, Ingres�lo nuevamente'); form.txtf_7.focus(); 												
                                                //return false;
												}//return true;
								else if( tel3.value=="") { alert('El FORMATO DEL NUMERO TELEFONICO ES INCORRECTO, Ingres�lo nuevamente'); form.txtf_8.focus(); 												
                                                //return false;
												}//return true;
...
function ValidateLlamSal(form)
								...
								if( juris.value=="") { alert('LA JURISDICCI�N es un dato necesario, ingresalo por favor'); form.txtf_jur.focus(); 												
                                                return false;
												}//return true;
...
function setSiNo(form) 
      		                       {//alert("entro");
      		                         var clides= form.slct_coincidir.value;
									 //alert("entro"+clides);
      		                         form.txtf_coincidir.value=clides;
								  	} 
						 ...
						 //  if(yearv>=2009 && yearv<=2018)
						   // {
						     if(year==5)
							 {
								 ...
								 //alert(""+day+" "+d.getDate());
								 if( (yearv<=2009 || yearv>2025) || (day<d.getDate() && month<=(d.getMonth()+1) && yearv<=2010))
								  {
									  
									if( (yearv<=2009 || yearv>2025))
										 {
									...
									if((day<d.getDate() && month<=(d.getMonth()+1) && yearv<=2010))
									     {
											 alert("Fecha Caduca, F�jate Mano!: "+day+"/"+month+"/"+yearv);
						                    document.form.txtf_t1.value="";
											document.form.txtf_t2.value="";
											document.form.txtf_t3.value="";
							                document.form.txtf_t1.focus();
...
//var issemym modi 060411
function putUbi_en1(form)
     {//alert("siiiii");
		var ubis= form.slct_marca.value
		form.txtf_marca1.value=ubis;
		 //form.txtf_descri.focus();
	 }
	 function putUbi_en2(form)
     {//alert("siiiii");
		var ubis= form.slct_um.value
		form.txtf_um1.value=ubis;
		 //form.txtf_descri.focus();
	 }
...
/*function confirmation() {
	var answer = confirm("DESEAS ELIMINAR")
	if (answer){
		//alert("DATOS ELIMINADOS")
		location.href='ubic_issemym1/eliminar_reg.jsp';
	}
	else{
		alert("Thanks for sticking around!")
	}
}*/
function setOrigen(form) 
      		                       {
      		                         var ubic_bod= form.slc_origen.value;
      		                         form.txtf_origen.value=ubic_bod;
      		                       }