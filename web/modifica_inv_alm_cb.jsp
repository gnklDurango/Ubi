<%@ page contentType="text/html; charset=iso-8859-1" language="java" import="java.sql.*" errorPage="" import="java.util.Date" import="java.text.SimpleDateFormat" session="true"%>
<%
...
<% Class.forName("org.gjt.mm.mysql.Driver");
    ...
    Connection conn__001 = DriverManager.getConnection("jdbc:mysql://localhost/dgo", "root", "eve9397");
    ...
    rset__001 = stmt__002.executeQuery("SELECT STR_TO_DATE('" + date + "', '%d/%m/%Y')");
    while (rset__001.next()) {
        date = rset__001.getString("STR_TO_DATE('" + date + "', '%d/%m/%Y')");
    }
    ...
    String cajas_jv = "", pzas_jv = "", resto_jv = "", origen_jv = "";
    ...
    /*String recibe_id_jv="";
     try {
     recibe_id_jv = request.getParameter("id_clave");       			   
     } catch (Exception e) { }*/
//out.print(recibe_id_jv);
    String eliminar_jv = "";
    try {
...
<script>
    ...
    if (entrar == true)
    {
        ...
        //self.location='eliminar_reg.jsp?&amp;id_clave=<%=recibe_id_jv%>&usuario=<%=usu_jv%>';
        self.location = 'eliminar_reg.jsp?id_clave=<%=recibe_id_jv%>&usuario=miguel';
    }
    else
    {
        alert("DATOS NO ELIMINADOS");
    }
//					  self.location='usa_menu.jsp?usuario=<%//=recibe_jv%>';
</script>
<% 		 
    }
    ...
    if (but.equals("Modificar")) {
        ...
        rset__002 = stmt__002.executeQuery("select clave,descr,lote,cadu,ubi,cant,cajas,piezas,resto,cod_bar from datos_inv_cod where id_cap_inv='" + recibe_id_jv + "'");
        ...
        while (rset__002.next()) {
            ...
            //origen_jv=rset__002.getString("origen");
            ...
            codigo_jv = rset__002.getString("cod_bar");
        ...
        ban = 1;
        //java.util.Calendar currDate = new java.util.GregorianCalendar();
        codigo_jv = request.getParameter("txtf_codigo");
...
//clave_jv=request.getParameter("txtf_2");
        // descrip_jv= request.getParameter("txtf_descrip");
        Connection conn
                = DriverManager.getConnection("jdbc:mysql://localhost/dgo", "root", "eve9397");
...
//stmt_fol.execute("update datos_small_fol set status=status+1 where folio_rece='"+folio+"'");
        ...
        stmt.execute("update datos_inv_cod set cod_bar='" + codigo_jv + "',clave='" + clave_jv + "',descr='" + descrip_jv + "',lote='" + lote2_jv + "',cadu='" + cad2_jv + "',ubi='" + ubi_jv + "',cajas='" + cajas_jv + "',piezas='" + pzas_jv + "',resto='" + resto_jv + "',cant='" + exi_jv + "',marca='" + marca_jv + "',um='" + present_jv + "',origen='" + origen_jv + "',coincidir_um='" + present1_jv + "' where id_cap_inv='" + recibe_id_jv + "'");
...
<%
        stmt.execute("insert into modi_dgo values ('" + user + "','" + correct1 + "','" + date + "','" + clave1_jv + "','" + descrip1_jv + "','" + lote21_jv + "','" + cad21_jv + "','" + ubi1_jv + "','" + cajas1_jv + "','" + pzas1_jv + "','" + resto1_jv + "','" + exi1_jv + "','" + clave_jv + "','" + descrip_jv + "','" + lote2_jv + "','" + cad2_jv + "','" + ubi_jv + "','" + cajas_jv + "','" + pzas_jv + "','" + resto_jv + "','" + exi_jv + "',0)");
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body bgcolor="#FFFFFF" onLoad="setcurCB1()">
        <script src="scw.js" type="text/javascript"></script>

        <table width="101%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr bgcolor="#3366CC">
                <td colspan="3" rowspan="2" bgcolor="#FFFFFF"><div align="left"></div></td>
                <td height="58" colspan="3" align="center" valign="bottom" nowrap="nowrap" bgcolor="#FFFFFF" id="logo"><div align="center"><img src="imagenes/logo_conjun.jpg"  /></div></td>
                <td width="47" bgcolor="#FFFFFF">&nbsp;</td>
            </tr>

            <tr bgcolor="#3366CC">
                <td height="40" colspan="3" align="center" valign="middle" background="imagenes/fondo.jpg"  id="tagline"><div align="left"><span class="di"><strong>Modificar Datos del Medicamento</strong></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>GNKL Software<span class="style6"> </span></strong></div></td>
                <td width="47" bgcolor="#FFFFFF">&nbsp;</td>
            </tr>
            ...
            <tr>
                <td width="73" valign="top" bgcolor="#E6F3FF">
                    ...
                    &nbsp;<br /> 	</td>
                <td>&nbsp;</td>
                <td colspan="2" valign="top"><img src="imagenes/mm_spacer.gif" alt="" width="305" height="1" border="0" />
                    <form action="modifica_inv_alm_cb.jsp" method="post" name="form">

                         
                        <table width="831" height="39" border="2" bordercolor="#003300">
                            <tr>
                                <td width="821"><p class="navText style4"><strong>MODIFIQUE LOS DATOS QUE UD. CREA CONVENIENTE: </strong></p>
                                    <table width="821" border="1">
                                        <%
                                            ...
                                            rset__001 = stmt__001.executeQuery("select clave,descr,lote,cadu,ubi,cant,cajas,piezas,resto,marca,um,origen,coincidir_um,cod_bar from datos_inv_cod where id_cap_inv='" + recibe_id_jv + "'");
                                            ...
                                            while (rset__001.next()) {
                                                ...
                                                codigo_jv = rset__001.getString("cod_bar");
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2"><input name="txtf_2" type="text" onChange="toUppercaseCve();" onKeyPress="return handleEnter(this, event)" value="<%=clave_jv%>" size="50" readonly  />
                                                <label></label></td>
                                        </tr>
                                        <tr>
                                            <td class="bodyText"><strong>DESCRIPCI&Oacute;N:</strong></td>
                                            <td colspan="2"><textarea name="txtf_descrip" cols="50" readonly onKeyPress="return handleEnter(this, event)"><%=descrip_jv%></textarea></td>
                                        </tr>
                                        <tr>
                                            <td class="bodyText"><strong>MARCA:</strong></td>
                                            <td colspan="2" class="A"><input name="txtf_marca" type="text" onKeyPress="return handleEnter(this, event)" value="<%=marca_jv%>" size="30" readonly  />
                                                &nbsp;
                                                <input name="txtf_marca1" type="text" size="3" onKeyPress="return handleEnter(this, event)" value="<%=marca1_jv%>" readonly />&nbsp;<label></label></td>
                                        </tr>
                                        <tr>
                                            <td class="bodyText"><strong>PRESENTACION:</strong></td>
                                            <td colspan="2" class="A"><input name="txtf_um" type="text" onKeyPress="return handleEnter(this, event)" value="<%=present_jv%>" size="30" readonly  />
                                                &nbsp;
                                                <input name="txtf_um1" type="text" size="3" onKeyPress="return handleEnter(this, event)" value="<%=present1_jv%>" readonly  />&nbsp;<label></label></td>
                                        </tr>
                                        <tr>
                                            <td class="bodyText"><strong>CODIGO DE BARRA:</strong></td>
                                            <td colspan="2"><input name="txtf_codigo" type="text" size="50" value="<%=codigo_jv%>" onChange="toUppercaseLote();" onKeyPress="return handleEnter(this, event)"/></td>
                                        </tr>
                                        <tr>
                                            <td class="bodyText"><strong>LOTE:</strong></td>
                                            <td colspan="2"><input name="txtf_lote_aux" type="hidden" value="<%=lote_aux_jv%>"/>
                                                <input name="txtf_lote" type="text" onChange="toUppercaseLote();" onKeyPress="return handleEnter(this, event)" value="<%=lote2_jv%>" size="50" /></td>
                                        </tr>
                                        <tr>
                                            <td height="34" class="bodyText"><strong>CADUCIDAD:</strong></td>
                                            <td colspan="2"><label>
                                                    <input name='txtf_caduc' type='text' id='txtf_caduc' title='DD/MM/AAAA' onclick='scwShow(this, event);' value="<%=cad2_jv%>" size='10' maxlength='10' />
                                                </label>
                                                <img src="imagenes/cal2.jpg" width="34" height="30" border="0" alt="De clic para MOSTRAR CALENDARIO" onClick="scwShow(scwID('txtf_caduc'), event);"/> </td>
                                        </tr>
                                        <tr>
                                            <td height="34" class="bodyText"><strong>ORIGEN:</strong></td>
                                            <td colspan="2"><input name="txtf_origen" type="text" id="txtf_origen" size="10"  value="<%=origen_jv%>" onKeyPress="return handleEnter(this, event)" onChange="toUppercaseUbic1();" readonly/>&nbsp;<select name="slc_origen" class="bodyText" onChange="setOrigen(this.form);">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2"><label>
                                                    <input type='text' name='txtf_ubi' id='txtf_ubi'  size='10' readonly maxlength='10' value="<%=ubi_jv%>"/>
                                                    <select name="slct_u" onChange="putUbi_en(this.form)">
                                                        ...
                                                        <option value="CONTROLADOS2">CONTROLADOS2</option>
                                                        <option value="CONTROLADOS3">CONTROLADOS3</option>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2"><label>
                                                    <input type='text' name='txtf_exi' id='txtf_exi' size='10' maxlength='10' value="<%=cajas_jv%>" onKeyUp="sumar();" onKeyPress="return isNumberKey(event);"/>
                                                </label></td>
                                        </tr>
                                        <tr>
                                            <td height="33" class="bodyText"><strong>PIEZAS/CAJAS:</strong></td>
                                            <td height="33" colspan="2"><input type='text' name='txtf_pza' size='10' maxlength='10' value="<%=pzas_jv%>" onKeyUp="sumar();" onKeyPress="return isNumberKey(event);"/></td>
                                        </tr>
                                        <tr>
                                            <td height="33" class="bodyText"><strong>RESTO:</strong></td>
                                            <td height="33" colspan="2"><input type='text' name='txtf_rto' size='10' maxlength='10' value="<%=resto_jv%>" onKeyUp="sumar();" onKeyPress="return isNumberKey(event);"/></td>
                                        </tr>
                                        <tr>
                                            <td height="21" class="bodyText"><strong>EXISTENCIA:</strong></td>
                                            <td height="21"><input type='text' name='txtf_exis2' size='10'onclick="" maxlength='10' value="<%=exi_jv%>" readonly="readonly"/></td>
                                            <td height="21"><a href="login?ban=9&nombre=<%=user%>&clave=<%=clave_jv%>">Regresar a Programa de Ubicaci&oacute;n POR CLAVE</a></td>
                                        </tr>
                                        <tr>
                                            <td height="21"><label></label></td>
                                            <td height="21"><input name="Submit" type="submit" class="subHeader" value="Modificar" onClick="return validaAct();"/>
                                              &nbsp;&nbsp;&nbsp; <!--a href="eliminar_reg.jsp?&amp;id_clave=<%=recibe_id_jv%>&usuario=<%=usu_jv%>"--><!--/a--><input name="Submit" type="submit" class="subHeader"  value="Eliminar"/></td>
                                            <td height="21"><a href="login?ban=8&nombre=<%=user%>&cb=<%out.println((String) sesion.getAttribute("cb"));%>" >Regresar a Programa de Ubicaci&oacute;n C&Oacute;DIGO DE BARRAS</a></td>
                                        </tr>
                                    </table>      </tr>
                        </table>
                        <p>&nbsp;</p>
...
<SCRIPT language=Javascript>
    ...
    function validaAct() {
        var cajas = document.form.txtf_exi.value;
        var piezas = document.form.txtf_pza.value;
        var resto = document.form.txtf_rto.value;
        var exis = document.form.txtf_exis2.value;
    <%
                    if (rol < 4) {
    %>
        if (cajas > <%=cajas_jv%> || piezas > <%=pzas_jv%> || resto > <%=resto_jv%> || exis > <%=exi_jv%>) {
            alert('No se puede poner una cantidad mayor');
            return false;
        }
    <%
    ...
    %>
        ...
        if (cajas === "" || piezas === "" || resto === "" || exis === "") {
            alert('Alguna cantidad esta vacía, verifique');
            return false;
        }
        return true;
    }
    ...
    function sumar() {
        ...
        var c = parseInt(cajas);
        var p = parseInt(piezas);
        var r = parseInt(resto);
        var exis = r + (c * p);
        document.form.txtf_exis2.value = exis;
    }
//-->
</SCRIPT>
