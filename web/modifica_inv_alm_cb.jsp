...
%>
            ...
            <tr>
              ...
              <td colspan="2"><textarea name="txtf_descrip" cols="50" onkeypress="return handleEnter(this, event)"><%=descrip_jv%></textarea></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td class="bodyText"><strong>MARCA:</strong></td>
              <td colspan="2" class="A"><input name="txtf_marca" type="text" size="30" onkeypress="return handleEnter(this, event)" value="<%=marca_jv%>"  />
                &nbsp;
                <input name="txtf_marca1" type="text" size="3" onkeypress="return handleEnter(this, event)" value="<%=marca1_jv%>" readonly="readonly" />&nbsp;<label></label></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td class="bodyText"><strong>PRESENTACION:</strong></td>
              <td colspan="2" class="A"><input name="txtf_um" type="text" size="30" onkeypress="return handleEnter(this, event)" value="<%=present_jv%>"  />
                &nbsp;
                <input name="txtf_um1" type="text" size="3" onkeypress="return handleEnter(this, event)" value="<%=present1_jv%>" readonly="readonly"  />&nbsp;<label></label></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td colspan="2"><input name="txtf_origen" type="text" id="txtf_origen" size="10"  value="<%=origen_jv%>" onkeypress="return handleEnter(this, event)" onchange="toUppercaseUbic1();" readonly="true"/>&nbsp;<select name="slc_origen" class="bodyText" onchange="setOrigen(this.form);">
...
<option value="H-40-I">H-40-I </option>
            ...
            <tr>
              ...
              <td height="21"><input type='text' name='txtf_exis2' size='10'onclick="putSuma1(this.form)" maxlength='10' value="<%=exi_jv%>"/></td>
              <td height="21"><a href="login?ban=1&nombre=<%=user%>">Regresar a Programa de Ubicaci&oacute;n POR CLAVE</a></td>
              <td height="21">&nbsp;</td>
            </tr>
            <tr>
              ...
              <td height="21"><a href="ubi_dgo.jsp" >Regresar a Programa de Ubicaci&oacute;n C&Oacute;DIGO DE BARRAS</a></td>
              <td height="21">&nbsp;</td>
            </tr>
          </table>      </tr>
    </table>
